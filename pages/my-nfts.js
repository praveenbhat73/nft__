...
const MyNFTs = () => {
  ...
  const userName=user?.publicMetadata?.lastName;
      ...
      <div className="w-full flexCenter flex-col">
        ...
        <div className="flexCenter flex-col -mt-20 z-0">
          <div className="flexCenter w-40 h-40 sm:w-36 sm:h-36 p-1 bg-nft-black-1 rounded-full">
            <Image src={userImage} className="rounded-full" objectFit="cover" width={150} height={150} />
          </div>
          
          <p className="font-poppins dark:text-white text-nft-black-1 font-semibold text-2xl mt-6">{userName}</p>
        </div>
      </div>
